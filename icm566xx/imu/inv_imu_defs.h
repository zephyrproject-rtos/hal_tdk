...
#define INVALID_VALUE_FIFO_20         ((int32_t)0x80000)
...
/* fifo_depth */
typedef enum {
	FIFO_CONFIG0_FIFO_DEPTH_MAX = 0x0F,
	FIFO_CONFIG0_FIFO_DEPTH_APEX = 0x09,
	/*FIFO size with EDMP Feature in SRAM: 0x700*/
	FIFO_CONFIG0_FIFO_DEPTH_APEX_WITH_RAM_FEATURE = 0x06,
	FIFO_CONFIG0_FIFO_DEPTH_HG_FEATURE = 0x03
...
/* accel_lp_avg_sel */
typedef enum {
	IPREG_SYS2_REG_110_ACCEL_LP_AVG_64 = 0xC,
	IPREG_SYS2_REG_110_ACCEL_LP_AVG_32 = 0xB,
	IPREG_SYS2_REG_110_ACCEL_LP_AVG_20 = 0xA,
	IPREG_SYS2_REG_110_ACCEL_LP_AVG_18 = 0x9,
